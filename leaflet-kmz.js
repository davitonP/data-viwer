! function (e, t) {
    ...
    function n(e, t) {
        ...
        }(e.getElementsByTagName("LatLonBox")[0]), n = e.getElementsByTagName("href")[0], r = e.getElementsByTagName("color")[0], a = e.getElementsByTagName("Icon")[0], s = {};
        return !n && a && (n = a.getElementsByTagName("href")[0]), n = n.childNodes[0].nodeValue, n = t.icons[n] || n, r && (r = r.childNodes[0].nodeValue, s.opacity = parseInt(r.substring(0, 2), 16) / 255, s.color = "#" + r.substring(6, 8) + r.substring(4, 6) + r.substring(2, 4)), i && (s.rotation = i), new L.KMZImageOverlay(n, o, {
            opacity: s.opacity,
            angle: s.rotation
        })
    }
    ...
    const a = L.KMZLayer = L.FeatureGroup.extend({
        ...
        load: function (e, polygon=null) {
            ...
            L.KMZLayer._jsPromise = i(this._requiredJSModules(), L.KMZLayer._jsPromise).then((() => {
                return t = e, new Promise(((e, o) => {
                    ...
                    i.open("GET", t), i.setRequestHeader("X-Requested-With", "XMLHttpRequest"), i.responseType = "arraybuffer", i.onload = () => {
                        4 !== i.readyState || 200 !== i.status && 0 !== i.status ? e("") : e(i.response || i.responseText)
                    }, i.onerror = () => o("Error " + i.status + " while fetching remote file: " + t), i.send()
                }));
                var t
            })).then((t => {
                return this.parse(t, {
        ...
        _parseKML: function (e, t) {
            ...
            this.addLayer(n), this.fire("load", {
                layer: n,
            ...
            var o = this._map ? this._map.options.preferCanvas : this.options.preferCanvas,
                ...
                r = L.geoJson(e, {
                    pointToLayer: (t, n) => o ? L.kmzMarker(n, {
                        iconUrl: e.properties.icons[t.properties.icon] || t.properties.icon || i,
                        iconSize: [28, 28],
                        iconAnchor: [14, 14],
                    ...
                    onEachFeature: (e, t) => {
                        if (this.options.ballon) {
                            var o = e.properties,
                                i = o.name || "",
                                n = o.description || "";
                            (i || n) && (this.options.bindPopup && t.bindPopup("<div><b>" + i + "</b><br>" + n + "</div>"), this.options.bindTooltip && t.bindTooltip("<b>" + i + "</b>", {
                                direction: "auto",
                                sticky: !0
                            }))
                        }
    ...
    }), e.KMZLayer = a, e.KMZMarker = s, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}));
