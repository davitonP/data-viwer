...
# python shapefile2kml.py /home/dvelasco/projects/earthquake-viwer/public/files/Fallas_California_WGS84_Regionales/Fallas_California_WGS84_Regionales.shp fallaRegionales
...
def convert(infilename, outfilename='doc.kml', namecolumn=0):
    ...
    for sr in sf.shapeRecords():
        if sr.shape.points:
            pm = kml.Placemark(name=str(sr.record[namecolumn]),
                    description= "test")
